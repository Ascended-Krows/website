...
import { footerMenuList, socialIcons } from '../data/footer';
        ...
        <div className="container">
          <div className="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
            <div className="col-span-3 md:col-span-4">
              ...
              <p className="dark:text-jacarta-300 mb-12">
                Buy, sell and collect Ascended Krows. Powered by Immutable X.
              </p>
          ...
          <div className="flex flex-col items-center justify-between space-y-2 py-8 sm:flex-row sm:space-y-0">
            <span className="dark:text-jacarta-400 text-sm">
              <span>© {new Date().getFullYear()} Ascended Krows — Made by</span>
              <Link href="https://krows.xyz">
                <a className="hover:text-accent dark:hover:text-white"> AK Team</a>
              </Link>
            </span>
